 ...
 */
export declare function Process(type: `models.${string}.Reload`): void;

/**
 * Read the model's metadata
 * @param type models.**WidgetID**.Read
 */
export declare function Process(type: `models.${string}.Read`): MetaData;

/**
 * Check if a model exists
 * @param type models.**WidgetID**.Exists
 */
export declare function Process(type: `models.${string}.Exists`): boolean;
